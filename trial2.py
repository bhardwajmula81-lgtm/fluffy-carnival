...
from PyQt5.QtWidgets import (
    ...
    QFileDialog, QCompleter, QGroupBox, QPlainTextEdit, QScrollArea, QDockWidget
)
...
class BatchSizeWorker(QThread):
    ...
    def get_size(self, path):
        ...
        # Native python os.scandir replacement for 'du' to prevent shell spanning freezes
        total_size = 0
        try:
...
class PDDashboard(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Enhanced Progress UI (Skeleton Loading Overlay)
        ...
        # Disabled auto-resize here to prevent lockups. Handled in safe_expand_all
...
"""
    ...
    def start_fs_scan(self):
        ...
        self.tree.setEnabled(False) # Skeleton UX
    ...
    def on_scan_finished(self, ws, out, ir, stats):
        ...
        self.tree.setEnabled(True) # Restore Skeleton UX
    ...
    def refresh_view(self):
        ...
        # Update Live Mini Pie Chart & Stars
        p = f = r = 0
    ...
    def on_context_menu(self, pos):
        ...
        # New Features specific to Runs and Stages
